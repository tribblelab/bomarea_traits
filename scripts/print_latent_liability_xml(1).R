...
# prepForLatentLiability("~/Dropbox/Metazoans/250_species/0_data/trait_data.csv",species = read.nexus("~/Dropbox/Metazoans/250_species/2_phylogeny_inference/3_mcc_trees_for_figures/ginsi_uced_ordered.tre")$tip.label)
